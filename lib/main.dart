...
String _buildPrompt(String mode, String langCode) {
  ...
  final String mode0 = (mode == 'premium' && !_isPremium) ? 'standard' : mode;
  final Map<String, String> modePrompts = prompts[mode0] ?? prompts['standard']!;
...
Future<void> _analyzeImage() async {
  ...
  try {
    final String langCode = FridgeApp.of(context)?._locale.languageCode ?? 'fr';
    final List<int> imageBytes = await _image!.readAsBytes();
    final String base64Image = base64Encode(imageBytes);
    final String prompt = _buildPrompt(_selectedMode, langCode);

    final String url = 'https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key=$_geminiApiKey';
    ...
    showDialog<void>(
      ...
      builder: (BuildContext ctx) => AlertDialog(
        ...
        title: Text(l10n.premiumTitle, style: const TextStyle(color: Color(0xFF00C853))),
        content: Column(
          mainAxisSize: MainAxisSize.Min,
          children: [
            Text(l10n.premiumDesc, style: const TextStyle(color: Color(0xFFD0D0D0))),
  ...
  void _showLanguageDialog() {
    ...
    showDialog<void>(
      ...
      builder: (BuildContext ctx) => AlertDialog(
        backgroundColor: const Color(0xFF141414),
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
        title: Text(l10n.languageTitle, style: const TextStyle(color: Color(0xFF00C853))),
        content: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
  ...
  Widget _languageTile(String label, Locale locale, BuildContext ctx) {
    final bool isSelected = FridgeApp.of(context)?._locale.languageCode == locale.languageCode;
    return ListTile(
      title: Text(label, style: TextStyle(
          color: isSelected ? const Color(0xFF00C853) : const Color(0xFFD0D0D0))),
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: isSelected ? const Color(0xFF00C853) : const Color(0xFF141414),
          borderRadius: BorderRadius.circular(10),
          border: Border.all(
            color: isSelected ? const Color(0xFF00C853) : const Color(0xFF2A2A2A),
          ),
        ),
        child: Row(
          mainAxisSize: MainAxisSize.min,
          children: [
            Icon(isLocked ? Icons.lock : icon, size: 16,
                color: isSelected ? const Color(0xFF0A0A0A) : const Color(0xFF888888)),
          ...
          children: [
            ...
            if (_isPremium)
              Container(
                ...
                decoration: BoxDecoration(color: const Color(0xFF00C853).withOpacity(0.15),
                    borderRadius: BorderRadius.circular(8)),
                child: const Text('✨ Premium', style: TextStyle(color: Color(0xFF00C853), fontSize: 12)),
              ),
          ],
        ),
        actions: [
              ...
              child: Column(
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                          color: _image != null ? const Color(0xFF00C853) : const Color(0xFF2A2A2A),
                          width: 1.5,
                        ),
                      ),
                      child: _image != null
                          ...
                          : Column(
                              ...
                              children: [
                                Icon(Icons.photo_library, size: 48, color: const Color(0xFF888888)),
                  ...
                  Wrap(
                    ...
                    runSpacing: 10,
                    children: [
                      _modeChip('standard', 'Standard', Icons.restaurant),
                      _modeChip('diet', 'Diet', Icons.fitness_center),
                      _modeChip('health', 'Health', Icons.health_and_safety),
                      _modeChip('premium', 'Premium', Icons.star),
                    ],
                  ),
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: _isLoading
                          ...
                          : Text(l10n.analyzeButton, style: const TextStyle(fontSize: 18)),
                    ),
                  ),
                  ...
                  if (_result.isNotEmpty)
                    Container(
                      ...
                      child: Text(_result, style: const TextStyle(color: Color(0xFFD0D0D0), height: 1.5)),
                    ),
                ],
              ),
            ),
